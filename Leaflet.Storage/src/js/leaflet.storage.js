...
L.Map.mergeOptions({
    ...
    default_fill: true,
    default_weight: 3,
    default_iconClass: 'Blank',
    default_zoomTo: 16,
    //default_popupContentTemplate: '# {name}\n{description}',
    default_popupContentTemplate: '{description}',
...
L.Storage.Map.include({
	...
	/********************************************************/
	/*    Gestion de la disposition des menus à gauche      */ 
	/*                                                      */
	/*    C'est ici qu'il faudra faire des modifications    */ 
	/*    pour ajouter des menus supplémentaires gauches    */
	/********************************************************/

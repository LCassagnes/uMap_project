    ...
    edit: function () {
        ...
        var container = L.DomUtil.create('div'),
            metadataFields = [
                'options.name',
                'options.description',
				/*'options.titlepolice', //Rajout pour la gestion de la police du titre de la popup
				'options.titlecolor', //Rajout pour la gestion de la couleur du titre de la popup
				'options.titlestyle', //Rajout pour la gestion du style du titre de la popup
				'options.titleweight', //Rajout pour la gestion du poids du titre de la popup
				'options.titledecoration', //Rajout pour la gestion du soulignement du titre de la popup
				'options.descriptioncolor', //Rajout pour la gestion de la couleur de la description*/
		...
		/*          															        */
		/*        RAJOUT    													        */
		/*        Eléments de menu pour le titre de la popup, ils seront ajoutés        */
		/*		  les uns à la suite des autres avant d'être encapsulés dans un         */
		/*        menu global appelé 'Title properties'.                                */
		/*        Les éléments de ce menu font référence au fichier du projet           */
		/*        'leaflet.storage.forms.js qui contient leur définitions et leur       */
		/*        type.       															*/
		/*          															        */
		/*------------------------------------------------------------------------------*/

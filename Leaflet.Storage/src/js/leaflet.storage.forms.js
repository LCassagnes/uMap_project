...
//Menu du choix du type de marker
...
//Menu du choix de template pour la popup du marker
...
/*        RAJOUT    													                       */
/*          															                       */
/*        Définition des éléments de menu pour le titre de la popup, ils seront ajoutés        */
/*		  les uns à la suite des autres avant d'être encapsulés dans un                        */
/*        menu global appelé 'Title properties'.                                               */
/*          															                       */
/*        titlePopupPolice = choix de la police du titre de la popup						   */
/*        titlePopupStyle = choix du style du titre de la popup 							   */
/*        titlePopupWeight = choix du titre en gras ou normal                                  */
/*        titlePopupUnderline = choix du titre souligné ou non                                 */
/*          															                       */
/*---------------------------------------------------------------------------------------------*/
...
L.S.ElementHelper.umapFont = L.S.ElementHelper.SelectAbstract.extend({
    ...
    selectOptions: [
		...
		['Andale Mono', L._('Andale Mono')],
        ['Arial', L._('Arial')],
		['Arial Black', L._('Arial Black')],
        ['Avantgarde', L._('Avantgarde')],
		['Berlin Sans FB', L._('Berlin Sans FB')],
		['Calibri', L._('Calibri')],
		['Century Gothic', L._('Century Gothic')],
		['Comic Sans MS', L._('Comic Sans MS')],
		['Courier', L._('Courier')],
		['Courier New', L._('Courier New')],
		['Geneva', L._('Geneva')],
		['Georgia', L._('Georgia')],
        ['Helvetica', L._('Helvetica')],
		['Impact', L._('Impact')],
		['Tahoma', L._('Tahoma')],
		['Times', L._('Times')],
		['Times New Roman', L._('Times New Roman')],
		['Trebuchet', L._('Trebuchet')],
		['Trebuchet MS', L._('Trebuchet MS')],
        ['Verdana', L._('Verdana')]
    ]
